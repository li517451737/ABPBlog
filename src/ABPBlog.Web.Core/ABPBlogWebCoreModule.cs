...
namespace ABPBlog
{
    ...
    public class ABPBlogWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ABPBlogWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ABPBlogWebCoreModule).GetAssembly());
        }
    }
}
